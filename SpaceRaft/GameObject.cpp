...
GameObject::GameObject(string filename, float x, float y, int width, int height, Game* game) {
	this->game = game;
...
bool GameObject::isOverlap(GameObject* actor) {
	bool overlap = false;
